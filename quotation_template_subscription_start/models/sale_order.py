...
class SaleOrder(models.Model):
    ...
    def _confirm_subscription(self):
        # Method override to add "start_after_days" in start_date based on quotation template
        # Original Odoo function - comes from the following part of the code:
        ...
        for sub in self:
            if sub.sale_order_template_id.start_after_days:
                ...
                sub.write({'next_invoice_date': today})
